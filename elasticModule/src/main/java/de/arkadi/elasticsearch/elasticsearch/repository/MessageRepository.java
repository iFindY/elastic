...
public class MessageRepository {
    ...
    public List getStateCompletion(String request) throws IOException {
        ...
        HttpEntity suggest = new NStringEntity(completion.replace("?", request), ContentType.APPLICATION_JSON);
        ...
        return completion.stream()
                .map(x -> {
                    ...
                    temp.put("location", ((HashMap<String, Object>) x.get("_source")).get("userLocation"));
                    temp.put("id", ((HashMap<String, Object>) x.get("_source")).get("id"));
                    return temp;
                })
                .distinct()
                .collect(Collectors.toList());
